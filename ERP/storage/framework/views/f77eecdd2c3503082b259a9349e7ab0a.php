...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::textarea('comment',null,array('class'=>'form-control' , 'placeholder'=>__('Comment')))); ?>
...
<?php endif; ?>
<?php /**PATH /home/ritcoerp/public_html/resources/views/interviewSchedule/create.blade.php ENDPATH**/ ?>