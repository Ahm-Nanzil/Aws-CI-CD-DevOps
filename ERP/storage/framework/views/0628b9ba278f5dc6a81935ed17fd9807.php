                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($proposal->status == 4): ?>
                                            <span class="badge bg-success p-2 px-3 rounded status_badge"><?php echo e(__(\App\Models\Proposal::$statues[$proposal->status])); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <?php if(Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal')): ?>
                                        <td class="Action">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($invoice->status == 4): ?>
                                            <span class="badge bg-success p-2 px-3 rounded status_badge"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <?php if(Gate::check('edit invoice') || Gate::check('delete invoice') || Gate::check('show invoice')): ?>
                                        <td class="Action">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/customer/show.blade.php ENDPATH**/ ?>