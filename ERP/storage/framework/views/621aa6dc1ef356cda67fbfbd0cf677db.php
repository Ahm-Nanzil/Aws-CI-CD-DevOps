...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'quotation','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                ...
                                <?php echo e(Form::text('customer_id', $customer->name, array('class' => 'form-control select','required'=>'required','readonly' => 'readonly'))); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('warehouse_id', $warehouse->name, array('class' => 'form-control warehouse_id','required'=>'required','readonly' => 'readonly'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('quotation_date',$quotation_date,array('class'=>'form-control','required'=>'required'))); ?>
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-1">
                                    <div class="item_div">
                                        ...
                                        <?php echo e(Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('quotation.product'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/quotation/quotation_create.blade.php ENDPATH**/ ?>