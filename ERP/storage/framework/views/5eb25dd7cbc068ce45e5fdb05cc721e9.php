                    ...
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 job-card">
                            <div class="job-card-body">
                                ...
                                <a href="<?php echo e(route('job.requirement', [$job->code, !empty($job) ? (!empty($job->createdBy->lang) ? $job->createdBy->lang : 'en') : 'en'])); ?>" class="btn btn-primary w-100 mt-4"><?php echo e(__('Read more')); ?></a>
...
<?php /**PATH /home/ritcoerp/public_html/resources/views/job/career.blade.php ENDPATH**/ ?>