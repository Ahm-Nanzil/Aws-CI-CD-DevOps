                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('copy invoice')): ?>
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#" id="<?php echo e(route('invoice.link.copy',[$invoiceID])); ?>"
                                                               ...
                                                               data-bs-toggle="tooltip" title="<?php echo e(__('Copy Invoice')); ?>" data-original-title="<?php echo e(__('Copy Invoice')); ?>"><i class="ti ti-link text-white"></i></a>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/invoice/index.blade.php ENDPATH**/ ?>