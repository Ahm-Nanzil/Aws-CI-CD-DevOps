                            ...
                            <tbody>
                                <?php $__currentLoopData = $userdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="me-5 badge p-2 px-3 rounded bg-success status_badge"><?php echo e($user->user_type); ?></span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete user')): ?>
                                                <div class="action-btn bg-danger ms-2">
                                                    <?php echo Form::open(['method' => 'DELETE','route' => ['user.userlogdestroy', $user->id],'id' => 'delete-form-' . $user->id,]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/user/userlog.blade.php ENDPATH**/ ?>