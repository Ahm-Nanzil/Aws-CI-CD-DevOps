    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on("click", ".payslip_delete", function () {
                ...
                show_toastr('error', 'This operation is not perform due to demo mode.');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/payslip/index.blade.php ENDPATH**/ ?>