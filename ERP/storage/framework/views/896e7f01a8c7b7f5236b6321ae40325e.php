    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('subject',null,array('class'=>'form-control' , 'placeholder'=>'Enter Subject'))); ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('target_achievement',null,array('class'=>'form-control' , 'placeholder'=>'Enter Traget Achievement'))); ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('description',null,array('class'=>'form-control' , 'placeholder'=>'Enter Description'))); ?>
...
<?php /**PATH /home/ritcoerp/public_html/resources/views/goaltracking/create.blade.php ENDPATH**/ ?>