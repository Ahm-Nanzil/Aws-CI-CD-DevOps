...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('place_of_visit',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Country')))); ?>
...
<?php /**PATH /home/ritcoerp/public_html/resources/views/travel/create.blade.php ENDPATH**/ ?>