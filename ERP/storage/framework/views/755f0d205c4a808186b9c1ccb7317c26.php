...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        '<?php echo e(url('/purchase/preview')); ?>/'
        +
        template
        +
        '/'
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-purchase-tab" data-bs-toggle="pill" href="#pills-purchase"
                            ...
                            aria-selected="false"><?php echo e(__('Purchase Print Setting')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-quotation-tab" data-bs-toggle="pill" href="#pills-quotation"
                            role="tab" aria-controls="pills-pos"
                            aria-selected="false"><?php echo e(__('Quotation Print Setting')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-pos-tab" data-bs-toggle="pill" href="#pills-pos" role="tab"
                            aria-controls="pills-pos" aria-selected="false"><?php echo e(__('POS Print Setting')); ?></a>
                    </li>
                                ...
                                <div class="col-md-3">
                                    <div class="card-body">
                                        ...
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('purchase.template.setting')); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="address"
                                                    class="form-label"><?php echo e(__('Purchase Template')); ?></label>
                                                <select class="form-control" name="purchase_template">
                                                    <?php $__currentLoopData = App\Models\Utility::templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e(isset($settings['purchase_template']) && $settings['purchase_template'] == $key ? 'selected' : ''); ?>>
                                                        ...
                                                        <div class="col-auto">
                                                            <label class="colorinput">
                                                                <input name="purchase_color" type="radio"
                                                                    ...
                                                                    <?php echo e(isset($settings['purchase_color']) && $settings['purchase_color'] == $color ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-9">
                                    <?php if(isset($settings['purchase_template']) && isset($settings['purchase_color'])): ?>
                                        <iframe id="purchase_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('purchase.preview', [$settings['purchase_template'], $settings['purchase_color']])); ?>"></iframe>
                                    <?php else: ?>
                                        <iframe id="purchase_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('purchase.preview', ['template1', 'fffff'])); ?>"></iframe>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body">
                                        <h5></h5>
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('quotation.template.setting')); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="address" class="form-label"><?php echo e(__('Quotation Template')); ?></label>
                                                <select class="form-control" name="quotation_template">
                                                    <?php $__currentLoopData = App\Models\Utility::templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e(isset($settings['quotation_template']) && $settings['quotation_template'] == $key ? 'selected' : ''); ?>>
                                                            <?php echo e($template); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <label class="colorinput">
                                                                <input name="quotation_color" type="radio"
                                                                    value="<?php echo e($color); ?>" class="colorinput-input"
                                                                    <?php echo e(isset($settings['quotation_color']) && $settings['quotation_color'] == $color ? 'checked' : ''); ?>>
                                                                <span class="colorinput-color"
                                                                    style="background: #<?php echo e($color); ?>"></span>
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label"><?php echo e(__('Quotation Logo')); ?></label>
                                                <div class="choose-files mt-2 ">
                                ...
                                <div class="col-md-9">
                                    <?php if(isset($settings['quotation_template']) && isset($settings['quotation_color'])): ?>
                                        <iframe id="quotation_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('quotation.preview', [$settings['quotation_template'], $settings['quotation_color']])); ?>"></iframe>
                                    <?php else: ?>
                                        <iframe id="quotation_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('quotation.preview', ['template1', 'fffff'])); ?>"></iframe>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body">
                                        <h5></h5>
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('pos.template.setting')); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="pos_template">
                                                    <?php $__currentLoopData = App\Models\Utility::templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e(isset($settings['pos_template']) && $settings['pos_template'] == $key ? 'selected' : ''); ?>>
                                                            <?php echo e($template); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <label class="colorinput">
                                                                <input name="pos_color" type="radio"
                                                                    value="<?php echo e($color); ?>" class="colorinput-input"
                                                                    <?php echo e(isset($settings['pos_color']) && $settings['pos_color'] == $color ? 'checked' : ''); ?>>
                                                                <span class="colorinput-color"
                                                                    style="background: #<?php echo e($color); ?>"></span>
                                                            </label>
                                                        </div>
                                ...
                                <div class="col-md-9">
                                    <?php if(isset($settings['pos_template']) && isset($settings['pos_color'])): ?>
                                        <iframe id="pos_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('pos.preview', [$settings['pos_template'], $settings['pos_color']])); ?>"></iframe>
                                    <?php else: ?>
                                        <iframe id="pos_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('pos.preview', ['template1', 'fffff'])); ?>"></iframe>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/settings/pos.blade.php ENDPATH**/ ?>