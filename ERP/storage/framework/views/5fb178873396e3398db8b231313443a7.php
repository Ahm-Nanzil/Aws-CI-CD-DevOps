                ...
                <ul class="dash-navbar">
                    ...
                    <?php endif; ?>
                        ...
                        <!--------------------- End Products System ----------------------------------->
                          ...
                          <!--------------------- Start inventory and logistic System ----------------------------------->

                        <?php if( Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
                        <li class="dash-item dash-hasmenu">
                            
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext"><?php echo e(__('Inventory & Logistic')); ?></span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                            </a>
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php endif; ?>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'return-voucher')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.return-voucher')); ?>" class="dash-link"><?php echo e(__('Inventory receiving voucher')); ?></a>

                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'stock-export')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.stock-export')); ?>" class="dash-link"><?php echo e(__('Cust Delivery Notes')); ?></a>

                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'packing-list')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.packing-list')); ?>" class="dash-link"><?php echo e(__('Packing List')); ?></a>

                                </li>

                                <li class="dash-item <?php echo e((Request::segment(1) == 'delivery-note')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.delivery-notes')); ?>" class="dash-link">
                                        <?php echo e(__('Internal delivery note')); ?>

                                    </a>


                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'loss-adjustment')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.loss-adjustment')); ?>" class="dash-link">
                                        <?php echo e(__('Loss and adjustment')); ?>

                                    </a>


                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'cust-supp')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.cust-supp')); ?>" class="dash-link">
                                        <?php echo e(__('Cust & Supp Returns')); ?>

                                    </a>


                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'history')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.history')); ?>" class="dash-link">
                                ...
                                <li class="dash-item <?php echo e((Request::segment(1) == 'report')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory.report')); ?>" class="dash-link">
                                ...
                                <li class="dash-item <?php echo e((Request::segment(1) == 'inventory-general')?'active':''); ?>">
                                    <a href="<?php echo e(route('inventory-general.index')); ?>" class="dash-link"><?php echo e(__('Inventory Setup')); ?>
                        ...
                        <!--------------------- End inventory and logistic System ----------------------------------->
                        ...
                        <?php if(\Auth::user()->type!='super admin' && ( Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client'))): ?>
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php endif; ?>
                                <li class="dash-item <?php echo e((Request::route()->getName() == 'hierarchy.index' || Request::segment(1) == 'hierarchy' || Request::route()->getName() == 'hierarchy.edit') ? ' active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\Test Case\Aws-CI-CD-DevOps\ERP\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>