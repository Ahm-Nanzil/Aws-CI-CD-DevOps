    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('lastname',null,array('class'=>'form-control','required'=>'required' , 'placeholder'=>_('Enter Last Name')))); ?>
...
<?php /**PATH /home/ritcoerp/public_html/resources/views/trainer/create.blade.php ENDPATH**/ ?>