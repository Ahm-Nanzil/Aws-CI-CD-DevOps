...
<div class="pos-preview-main" id="boxes">
    <div class="pos-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?> "><?php echo e(__('POS')); ?></h3>
                ...
                <td class="text-right">
                    <img class="pos-logo"  src="<?php echo e($img); ?>"
                         alt="">
                    <p>
...
<?php /**PATH /home/ritcoerp/public_html/resources/views/pos/templates/template5.blade.php ENDPATH**/ ?>