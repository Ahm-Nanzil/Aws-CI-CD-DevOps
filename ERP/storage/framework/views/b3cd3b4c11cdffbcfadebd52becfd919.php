                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><?php echo e(\Auth::user()->priceFormat(($invoice->getTotal()-$getDue)-($creditNote))); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-end"><b><?php echo e(__('Credit Note')); ?></b></td>
                                                <td class="text-end"><?php echo e(\Auth::user()->priceFormat(($creditNote))); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-end"><b><?php echo e(__('Due')); ?></b></td>
                                                <td class="text-end"><?php echo e(\Auth::user()->priceFormat($getDue)); ?></td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/invoice/view.blade.php ENDPATH**/ ?>