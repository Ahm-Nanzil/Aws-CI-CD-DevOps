                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete job application')): ?>
                                    <li class="list-inline-item float-end">
                                        ...
                                        <a href="#" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" class="bs-pass-para"
                                           data-bs-toggle="tooltip" data-confirm-yes="document.getElementById('archive-form-<?php echo e($jobApplication->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ritcoerp/public_html/resources/views/jobApplication/show.blade.php ENDPATH**/ ?>